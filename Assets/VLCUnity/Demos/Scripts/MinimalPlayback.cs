    ...
    public void PlayPause()
    {
        ...
        else
        {
            ...
            if(_mediaPlayer.Media == null)
            {
             ...
             //   _mediaPlayer.Media = new Media(_libVLC, new Uri("rtsp://192.168.0.200/")); //("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"));
